...
public class SOAPOperationsXml {
	...
	public String callSoapWebService(String soapEndpointUrl, String soapAction, String[] val, String operation) {
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequest(soapAction, val, operation),
					soapEndpointUrl);
	...
	private SOAPMessage createSOAPRequest(String soapAction, String[] val, String operation) throws Exception {
		...
		createSoapOperateEnvelope(envelope, val, operation, nameSpace);
	...
	// Throw the operation used and the integer values to the element in the SOAP
	// WebService and creates an SOAP Envelope
	private void createSoapOperateEnvelope(SOAPEnvelope envelope, String[] val, String operation, String nameSpace) throws SOAPException {
		try {
